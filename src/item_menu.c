...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    */
    ...
    [ITEM_ORANGE_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_HARBOR_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_GLITTER_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_MECH_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_WOOD_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_WAVE_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_BEAD_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_SHADOW_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_TROPIC_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_DREAM_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_FAB_MAIL] = ITEM_TYPE_MAIL_BAG,
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL_BAG,
};
